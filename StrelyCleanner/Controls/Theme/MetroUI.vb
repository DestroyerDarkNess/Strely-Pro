...
#Region " State Handling "
    ...
    Protected State As MouseStateMetroUI
    Private Sub SetState(ByVal current As MouseStateMetroUI)
        State = current
        Invalidate()
    End Sub
    ...
    Protected Overrides Sub OnEnabledChanged(ByVal e As EventArgs)
        If Enabled Then SetState(MouseStateMetroUI.None) Else SetState(MouseStateMetroUI.Block)
        MyBase.OnEnabledChanged(e)
    End Sub

    Protected Overrides Sub OnMouseEnter(ByVal e As EventArgs)
        SetState(MouseStateMetroUI.Over)
    ...
    Protected Overrides Sub OnMouseLeave(ByVal e As EventArgs)
        SetState(MouseStateMetroUI.None)
    ...
    Protected Overrides Sub OnMouseDown(ByVal e As MouseEventArgs)
        If e.Button = Windows.Forms.MouseButtons.Left Then SetState(MouseStateMetroUI.Down)
...
#Region " State Handling "
    ...
    Protected Overrides Sub OnMouseUp(ByVal e As MouseEventArgs)
        If InPosition Then SetState(MouseStateMetroUI.Over)
        MyBase.OnMouseUp(e)
    End Sub
...
Enum MouseStateMetroUI As Byte
    None = 0
    Over = 1
    Down = 2
    Block = 3
...
Class Bouton
    ...
    Protected Overrides Sub PaintHook()
        ...
        Select Case State
            Case MouseStateMetroUI.None
                DrawText(textc, HorizontalAlignment.Center, 0, 0)
            Case MouseStateMetroUI.Over
                G.Clear(Color.FromArgb(49, 144, 166))
                DrawText(textc, HorizontalAlignment.Center, 0, 0)
            Case MouseStateMetroUI.Down
...
Class Check
    ...
    Protected Overrides Sub PaintHook()
        ...
        If State = MouseStateMetroUI.Over And X < 15 Then
            G.FillRectangle(New SolidBrush(Color.Black), New Rectangle(0, 0, 20, 20))
            G.FillRectangle(New SolidBrush(Color.White), New Rectangle(1, 1, 20 - 2, 20 - 2))
        ElseIf State = MouseStateMetroUI.Down And X < 15 Then
            G.FillRectangle(New SolidBrush(Color.Black), New Rectangle(0, 0, 20, 20))
            G.FillRectangle(New SolidBrush(Color.White), New Rectangle(1, 1, 20 - 2, 20 - 2))
        End If
